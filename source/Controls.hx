...
class Controls extends FlxActionSet
{
	...
	var _ui_upP = new FlxActionDigital(Action.UP);
	var _ui_leftP = new FlxActionDigital(Action.LEFT);
	var _ui_rightP = new FlxActionDigital(Action.RIGHT);
	var _ui_downP = new FlxActionDigital(Action.DOWN);
	var _ui_upR = new FlxActionDigital(Action.UP);
	var _ui_leftR = new FlxActionDigital(Action.LEFT);
	var _ui_rightR = new FlxActionDigital(Action.RIGHT);
	var _ui_downR = new FlxActionDigital(Action.DOWN);
